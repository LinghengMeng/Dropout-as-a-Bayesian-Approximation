...
model_L = VariationalDense(n_feats, n_hidden, model_prob, model_lam)
model_out = model_L(model_X, tf.nn.relu)
model_L = VariationalDense(n_hidden, n_hidden, model_prob, model_lam)
model_out = model_L(model_out, tf.nn.relu)
model_L = VariationalDense(n_hidden, 1, model_prob, model_lam)
